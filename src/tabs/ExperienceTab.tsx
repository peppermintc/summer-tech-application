    ...
    <Container>
      ...
      <Project>
        ...
        <Paragraph>
          ...
          <li>
            새로고침 후에도 스크랩 기사가 유지시키도록 하였습니다. (LocalStorage
            사용)
          </li>
          <li>
            기사 목록 페이지의 카테고리 필터 선택에 따라 분류하여야 합니다.
          </li>
        </Paragraph>
      </Project>
      ...
      <Project>
        ...
        <Paragraph>
          ...
          <li>
            HTML Video API를 이요하여 커스텀 비디오 플레이어를 구현해보았습니다.
          </li>
          <li>
            기본적인 비디오 플레이어 기능 구현에 추가로 다양한 아이디어를
            반영시켜 보았습니다.
          </li>
          <li>
            그림 그리기, 화면 이동, 확대/축소, 재생속도 설정, 밝기 조절 등이
            가능합니다.
          </li>
        </Paragraph>
      </Project>
